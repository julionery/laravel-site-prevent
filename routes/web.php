...
Route::get('/servicos/{id}/{titulo?}', ['as'=> 'site.servicos', 'uses' => 'Site\ServicoController@index']);
Route::get('/servicos', ['as'=> 'servicos', 'uses' => 'Site\ServicoController@servico']);
Route::get('/contato', ['as'=> 'site.contato', 'uses' => 'Site\HomeController@contato']);

Route::group(['prefix' => 'auth/'], function (){

    Route::group(['prefix' => 'github'], function (){
        Route::get('/', 'Socialite\GitHubController@redirect');
        Route::get('callback', 'Socialite\GitHubController@handle');
    });

    Route::group(['prefix' => 'facebook'], function (){
        Route::get('/', 'Socialite\FacebookController@redirect');
        Route::get('callback', 'Socialite\FacebookController@handle');
    });

    Route::group(['prefix' => 'twitter'], function (){
        Route::get('/', 'Socialite\TwitterController@redirect');
        Route::get('callback', 'Socialite\TwitterController@handle');
    });

    Route::group(['prefix' => 'google'], function (){
        Route::get('/', 'Socialite\GoogleController@redirect');
        Route::get('callback', 'Socialite\GoogleController@handle');
    });
});
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth', 'as' => 'admin.'], function () {
    ...
    Route::get('/slide', ['as' => 'slide', 'uses' => 'Admin\SlideController@index']);
    Route::get('/slide/adicionar', ['as' => 'slide.adicionar', 'uses' => 'Admin\SlideController@adicionar']);
    Route::post('/slide/salvar', ['as' => 'slide.salvar', 'uses' => 'Admin\SlideController@salvar']);
    Route::get('/slide/editar/{id}', ['as' => 'slide.editar', 'uses' => 'Admin\SlideController@editar']);
    Route::put('/slide/atualizar/{id}', ['as' => 'slide.atualizar', 'uses' => 'Admin\SlideController@atualizar']);
    Route::get('/slide/deletar/{id}', ['as' => 'slide.deletar', 'uses' => 'Admin\SlideController@deletar']);
